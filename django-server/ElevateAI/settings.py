"""
Django settings for ElevateAI project.
...
WSGI_APPLICATION = 'ElevateAI.wsgi.application'
...
# Custom User Model
AUTH_USER_MODEL = 'ElevateAI.User'
...
FROM_EMAIL = os.environ.get('FROM_EMAIL', 'noreply@elevateai.com')
